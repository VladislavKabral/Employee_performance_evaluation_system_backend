...
public class JWTFilter extends OncePerRequestFilter {
    ...
    @Autowired
    public JWTFilter(EmployeesDetailsService employeesDetailsService, JWTUtil jwtUtil) {
        ...
        if (authHeader != null && !authHeader.isBlank() && authHeader.startsWith("Bearer ")) {
            ...
            if (jwt.isBlank()) {
                ...
                try {
                    ...
                    UserDetails userDetails = employeesDetailsService.loadUserByUsername(username);
