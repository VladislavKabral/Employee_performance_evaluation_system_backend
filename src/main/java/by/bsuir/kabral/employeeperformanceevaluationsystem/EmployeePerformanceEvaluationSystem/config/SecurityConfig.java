...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/feedbacks/**").hasAnyAuthority("WORKER", "MANAGER", "DIRECTOR")
                .antMatchers("/packages/**").hasAnyAuthority("WORKER", "MANAGER", "DIRECTOR")
                .antMatchers("/questions/**").hasAnyAuthority("WORKER", "MANAGER", "DIRECTOR")
                .antMatchers("/forms/**").hasAnyAuthority("WORKER", "MANAGER", "DIRECTOR")
                .antMatchers("/users/**").hasAnyAuthority("WORKER", "MANAGER", "DIRECTOR")
                .antMatchers("/report/**").hasAnyAuthority("MANAGER", "DIRECTOR")
                .antMatchers("/skills/**").hasAnyAuthority("MANAGER", "DIRECTOR")
                .antMatchers("/teams/**").hasAnyAuthority("MANAGER", "DIRECTOR")
                .and()
                .exceptionHandling()
