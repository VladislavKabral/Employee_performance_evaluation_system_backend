...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/feedbacks/**").hasAnyRole("WORKER", "MANAGER", "DIRECTOR")
                .antMatchers("/packages/**").hasAnyRole("WORKER", "MANAGER", "DIRECTOR")
                .antMatchers("/questions/**").hasAnyRole("WORKER", "MANAGER", "DIRECTOR")
                .antMatchers("/forms").hasAnyRole("WORKER", "MANAGER", "DIRECTOR")
                .antMatchers("/users/**").hasAnyRole("WORKER", "MANAGER", "DIRECTOR")
